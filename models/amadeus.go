...
// AmadeusTestDetailedDataUnavailable represents the amadeus_test_detailed_data_unavailable table (DB model with GORM, JSON, and BigQuery tags)
type AmadeusTestDetailedDataUnavailable struct {
	ID        uint      `gorm:"primaryKey" json:"id" bigquery:"id"`
	HotelID   string    `gorm:"unique;not null" json:"hotelId" bigquery:"hotel_id"`
